...
var balls, collisionGroupBalls, collisionGroupObstacles, collisionGroupPlayers, collisionGroupWalls, cursors, game, mapSettings, maxAccel, ship, shootingAccel, sounds, walls;
...
game = new Phaser.Game(800, 600, Phaser.CANVAS, 'phaser-example', {
  ...
  create: function() {
    var ball, ballBallCM, ballMaterial, ballPlayerCM, ballPostCM, bmd, bmd2, fieldBounds, halfWorldHeight, halfWorldWidth, i, j, k, len1, len2, margin, nx, ny, onFieldGroup, playerMaterial, post, postMaterial, px, py, ref, ref1, wallMaterial, xx, yy;
  ...
  update: function() {
    var accel, b1, b2, ball, didKick, diffx, diffy, dist, i, len, len1, ref;
